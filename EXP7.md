...
□ Limited amount of money withdrawn per day (sufficient money) External Interface Requirements 
User interfaces 
...
### Software interfaces 
```
The software interfaces are specific to the target banking software ystems. At present, two known banking systems will participate in the ATM network. 
□ State Bank 
