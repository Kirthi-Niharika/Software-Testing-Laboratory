...
### Test Case Execution: 
```
Test Case Execution could be either manual or automatic involving tools ike QC, QTP or any other
```
### Database Testing: 
```
...
complies with standards like OWASP. In this stage the major task involves in the whole application scan which is carried out using tools like IBM Appscan or HP WebInspect (2 Most popular tools). 
...
-Check whether you are able to withdraw an amount in the newly created account (after deposit) (and thus updating the 
 balance) 
